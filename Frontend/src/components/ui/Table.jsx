...
export default function DashboardTable() {
  ...
  return (
    ...
    >
      {/* <p className="text-center text-3xl font-semibold m-2 underline underline-offset-4">
                        ...
                        return (
                          <>
                            <TableCell key={column.id} align={"center"}>
                              ...
                              <button className="mx-1 border-2 p-2 rounded-lg border-[#f70202] bg-[#f70202] font-semibold transition ease-out  hover:-translate-y-1 ">
                                Delete
                              </button>
                            </TableCell>
                          </>
